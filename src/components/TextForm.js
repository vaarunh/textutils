  ...
  return (
    <>
      <div className="container">
        <h2 style={{ color: props.mode === 'light' ? '#343a40' : '#D8E9A8' }}>{props.heading}</h2>
        <div className="mb-3">
          <textarea className="form-control mt-4" id="myBox" rows="9" value={text} onChange={handleOnChange} style={{ backgroundColor: props.mode === 'light' ? '#D8E9A8' : '#343a40', color: props.mode === 'light' ? '#343a40' : '#D8E9A8' }}></textarea>
        </div>
      ...
      <div className="container">
        <h2 style={{ color: props.mode === 'light' ? '#343a40' : '#D8E9A8' }}> Your Text Summary</h2>
        ...
        <hr style={{ color: props.mode === 'light' ? '#343a40' : '#D8E9A8' }} />
        <h2 className="mt-4" style={{ color: props.mode === 'light' ? '#343a40' : '#D8E9A8' }}>Your Text Preivew</h2>
